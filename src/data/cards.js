(function () {
  ...
  GameData.cards = [
    ...
    card("peer_letter", "托付同年", "人情", "人情", ["人情", "同年", "翰林"], { energy: 1, favor: 1 }, { tracks: { "流言滋生": -2, "案卷迟滞": -2 }, relations: { peers: { closeness: 2, debt: 1 } }, tags: { 圆滑: 1 } }, "同榜之谊可以救急，也会留下人情账。"),
    ...
    card("seal_document", "官样文章", "公文", "政务", ["政务", "朝廷"], { energy: 1 }, { tracks: { "流程迟滞": -3, "上意不明": -1 }, world: { courtPressure: -1 }, tags: { 能吏: 1 } }, "不动声色地把事情推过流程。"),
