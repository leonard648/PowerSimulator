(function () {
  ...
  GameData.events = [
    ...
    ev("hanlin_slander", "hanlin", "诗文招谤", "一首应制诗忽然从馆阁流到宫外，茶肆里有人称你借景讽上，书院中又有人赞其清切有骨。你尚未奉诏自陈，诗句已被传成数个版本；此刻要保的既是文名，也是君前那点尚未落定的信任。", { "流言滋生": 7, "上意不明": 5, "清议沸腾": 6, "文名不足": 3 }, ["皇帝", "士林", "政敌"], "流言转为文名，你的名声更响。", "诗名成了祸根，皇帝心中添了一分猜疑。"),
    ev("hanlin_mentor", "hanlin", "座师请托", "座师府上的老仆在下值后递来一卷奏稿，请你替一名新进门生润色几句。纸页不厚，来意却重：你若落笔，师门会记你肯顾旧恩；旁人也会看见你正被一条看不见的线牵进局里。", { "派系阻挠": 5, "举荐不足": 5, "清议沸腾": 4, "期限逼近": 3 }, ["座师", "同年", "士林"], "你顾全师门而未失公论。", "请托之事外泄，清名受损。"),
  ...
  GameData.eventDetails = {
    ...
    hanlin_mentor: detail(
      "这不是寻常润色，而是师门借你的笔替年轻门生试探馆阁风向。此类小事从不写进公文，却最容易写进人情账。",
      "黄昏刚下值，座师府上的老仆便候在廊外，袖中只藏着一卷奏稿和一句客气话：先生念你文章老成，愿请你顺手一改。你展开纸页时，墨色未干，薄薄几张却像压着整个师门的眼色。",
      "若推辞，座师会觉得你忘了当年提携；若应承，士林又会疑你替私门铺路。真正难处不在添删字句，而在你落下的每一笔，究竟是在报恩，还是在替自己认下一条线。",
      "史传里所谓门生故吏，多由这种不起眼的夜访积成。今日你替人添一字，明日或许就要替这一字解释清白。"
    ),
